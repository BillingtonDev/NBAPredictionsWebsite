...
IMPORTANT: ONLY RETURN THE OUTPUT (ODDS) IE. 2.5:1 (NOTHING ELSE)

The team matchup is: Bulls vs Raptors
...
def main():
    ...
    completion = client.chat.completions.create(model="gpt-4o", messages=[{
                ...
                "content": ChatPromptTemplate.from_template(PROMPT_TEMPLATE).format(team_ratings=ratings)}])
